        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="{{ route('admin.course_management.create_course') }}" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('Add Course') }}</a>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a target="_blank" href="{{ route('user.my_course.curriculum', ['id' => $course->id, 'lesson_id' => $course->lesson_id]) }}" class="dropdown-item">
                                  {{ __('Preview') }}
                                </a>
